    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="glass-card p-8">
          <h2 className="text-xl font-semibold mb-1" style={{ color: 'var(--text-primary)' }}>Selamat datang</h2>
          <p className="text-sm mb-6" style={{ color: 'var(--text-secondary)' }}>Masuk dengan akun Google Anda</p>
